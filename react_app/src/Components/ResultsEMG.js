   ...
   function button1Clicked()
   {
    ...
    return (
        <div className={styles.container}>
            ...
            <div>   
                {loaded && 
                    <Graph  xasis="interval"  yasis="area"  birthyear1={birthyear1}  birthyear2={birthyear2}  gender={gender}  link={ "emg/?sensor=" + sensor + "&subjectid="} ></Graph>
                }
            </div>
